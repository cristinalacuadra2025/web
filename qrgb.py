...
class MainMenu(BoxLayout):
    ...
    def load_qrgb(self, filechooser, selection, *args):
        if selection:
            try:
                ...
                # Añadir información de cada capa
                content.add_widget(Label(
                    text="Información decodificada:",
                    font_size='18sp',
                    size_hint_y=None,
                    height=30
                ))
                ...
                # Capa roja
                red_container = BoxLayout(
                    orientation='horizontal',
                    size_hint_y=None,
                    height=40
                )
                red_container.add_widget(Label(
                    text="Capa Roja:",
                    color=(1, 0, 0, 1),
                    size_hint_x=0.3
                ))
                red_container.add_widget(Label(
                    text=data_red if data_red else "No se pudo decodificar",
                    text_size=(400, None),
                    halign='left',
                    valign='middle',
                    shorten=True,
                ...
                content.add_widget(red_container)
                
                # Capa verde
                green_container = BoxLayout(
                    orientation='horizontal',
                    size_hint_y=None,
                    height=40
                )
                green_container.add_widget(Label(
                    text="Capa Verde:",
                    color=(0, 1, 0, 1),
                    size_hint_x=0.3
                ))
                green_container.add_widget(Label(
                    text=data_green if data_green else "No se pudo decodificar",
                    text_size=(400, None),
                    halign='left',
                    valign='middle',
                    shorten=True,
                ...
                content.add_widget(green_container)
                
                # Capa azul
                blue_container = BoxLayout(
                    orientation='horizontal',
                    size_hint_y=None,
                    height=40
                )
                blue_container.add_widget(Label(
                    text="Capa Azul:",
                    color=(0, 0, 1, 1),
                    size_hint_x=0.3
                ))
                blue_container.add_widget(Label(
                    text=data_blue if data_blue else "No se pudo decodificar",
                    text_size=(400, None),
                    halign='left',
                    valign='middle',
                    shorten=True,
                ...
                content.add_widget(blue_container)
                ...
                # Mostrar popup con la información decodificada
                result_popup = Popup(
                    title="Decodificación QRGB",
                    content=content,
                    size_hint=(0.9, 0.9)
                )
                ...
                self.show_popup("Error", f"Error al decodificar QRGB: {str(e)}")
        else:
            self.show_popup("Error", "No se seleccionó ningún archivo")
    ...
    def open_url(self, url):
        try:
            ...
            self.show_popup("Error", f"No se pudo abrir el navegador: {str(e)}")

class QRGBApp(App):
    def build(self):
        self.title = "QRGB - Generador de QR Multicapa"
        return MainMenu()
